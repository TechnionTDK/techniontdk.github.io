...
3. If this is an announcement, write the news item as usual and add `publications: [slug, ...]`
   in the order announced. If it is a plain filing, stop here — the record stands on its own.

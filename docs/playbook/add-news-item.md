...
Triggers: add a news item, add a new item, write up this event, we just had a visit, a talk by,
we hosted, X gave a talk, add this to the news
Updated: 2026-09-17
...
- **2026-09-17 — the body carries the human part.** Anything the site already holds as data is
  cross-referenced, not restated — see `add-accepted-papers` for the paper case.
